...
function SocialLink({ icon: Icon, children, ...props }) {
  return (
    <Link className="group -m-1 flex flex-row gap-1 p-1" {...props}>
      <Icon className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300" />
      <span className="text-zinc-500 transition group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300">
        {children}
      </span>
    </Link>
  )
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        download
        href="/files/linoy-avraham-resume.pdf"
        target="_blank"
        rel="noopener"
        variant="secondary"
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Linoy Avraham - Design, Passion</title>
        <meta
          name="description"
