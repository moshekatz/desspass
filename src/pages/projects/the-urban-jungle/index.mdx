...
import concept2 from './concept-2.webp'
...
<SideBySideLayout>
  ...
  <Image src={final4} alt="Final project 3"/>
  <Image src={final3} alt="Final project 4"/>
...
<SideBySideLayout>
  <Image src={concept1} alt="Concept illustration 1"/>
  <Image src={concept2} alt="Concept illustration 2"/>
</SideBySideLayout>

The existing structure has a lot of potential, and it played a key role in enabling the evolution of the square.

<SideBySideLayout>
  <Image src={existingVsPlanned4} alt="Existing vs. Planned 4" style={{ width: '90%' }}/>
  <Image src={existingVsPlanned5} alt="Existing vs. Planned 5" style={{ height: '100%' }}/>
</SideBySideLayout>
